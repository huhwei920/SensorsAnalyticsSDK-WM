#
#  Be sure to run `pod spec lint SensorsAnalyticsSDK-WM.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.version      = "1.0.0"
  spec.summary      = "A short description of SensorsAnalyticsSDK-WM."
  ...
  # Or just: spec.author    = "huhangwei"
  # spec.authors            = { "huhangwei" => "huhangwei@gmail.com" }
  # spec.social_media_url   = "https://twitter.com/huhangwei"
